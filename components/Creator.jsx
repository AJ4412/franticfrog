      ...
      <div className="container">
        ...
        <div className="d-flex justify-content-center">
          <p
            ...
            <br /> <br />Together, Edwin and Diane began to design Frankie and all of his attributes. This was a fun project, and together they made a great team. They shared design ideas. The Frantic Frog NFT collection ended up with 16 layers and 200 attributes, and Edwin who is an ophthalmic microsurgeon used his abilities of precision and spatial perception needed so that the over quadrillion possibilities that the 16 art layers would produce would fit together resulting in the most spectacular 10,000 art tokens ever.  
            Each layer has special rarities occurring in about 0.32% of the 10,000 NFTs.  Rarity traits are listed in OpenSea.  
            <br /> <br />From learning to design digital art to creating this website with the minting dAPP has been about a nine-month project.  We are happy to have brought the Frantic Frog NTF collection and the character of Frankie Frantic Frog (AKA FCUBE) to you.  Collect and enjoy the Frantic Frog Collection and be a part of the FCUBE Community. See Meet Frantic Frog and the RoadMap to learn more about FCUBE. It is only the beginning as we have discovered FCUBE is a superhero and has quite a mission ahead.
