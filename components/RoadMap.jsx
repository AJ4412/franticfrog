...
// import correctimg from "../assets/png/correct.png";
...
const RoadMap = () => {
  return (
    <div className="container" id="roadmap">
      ...
      <div className="row  py-md-3">
        <div className="col-md-6 my-4 mt-md-0">
          <div className="d-flex">
            <div className="">
              <div className="roadmap-round-circle d-flex justify-content-center align-items-center ">
                <img src="/png/correct.png" alt="correctimg" />
              </div>
            </div>
